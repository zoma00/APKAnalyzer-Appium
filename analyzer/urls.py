...
from .views import app_list, create_item,  delete_item ,register,edit_item, run_appium_test, app_detail
...
urlpatterns = [
    ...
    path('run-appium-test/', run_appium_test, name='run_appium_test'),
